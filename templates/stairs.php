...
с гарантией 30 лет							
			...
			<a href="modal" data-modal="get-call" class="btn btn-primary">Рассчитать стоимость лестницы</a>
		</div>
		<!-- /.col-left -->
...
<section id="portfolio" class="section">
    <div class="container">
        ...
        <div class="gallery lighbox-1">
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-001.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-001.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-002.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-002.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-003.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-003.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-004.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-004.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-005.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-005.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-006.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-006.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-007.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-007.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-008.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-008.jpg" alt="item">
            </a>
            <a class="item" href="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/lestnicy-iz-kamnya-010.jpg">
				<img class="lazy" data-src="<?php bloginfo("template_url"); ?>/src/img/gallery/stairs/thumbs/lestnicy-iz-kamnya-010.jpg" alt="item">
            </a>
